# Mastodon RSS Australia stack module

Content-only Platform Zero module providing curated independent Australian news feeds and Mastodon bootstrap follows to `mastodon-rss-publisher`.
